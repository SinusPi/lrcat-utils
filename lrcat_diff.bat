...
start powershell -WindowStyle hidden -command "get-content -Encoding UTF8 %TEMP%\sql.csv |convertfrom-csv |out-gridview -title '%1 <-> %2' -wait; remove-item '%TEMP%\sql.csv'"
